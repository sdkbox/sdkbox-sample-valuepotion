...
#endif
bool js_PluginValuePotionJS_PluginValuePotion_trackPurchaseEvent(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    ...
    JS_ReportErrorUTF8(cx, "js_PluginValuePotionJS_PluginValuePotion_trackPurchaseEvent : wrong number of arguments");
    return false;
}
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginValuePotionJS_PluginValuePotion_openInterstitial(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginValuePotionJS_PluginValuePotion_openInterstitial : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginValuePotionJS_PluginValuePotion_hasCachedInterstitial(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginValuePotionJS_PluginValuePotion_hasCachedInterstitial : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginValuePotionJS_PluginValuePotion_userinfo(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 2) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginValuePotionJS_PluginValuePotion_userinfo : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
#endif
bool js_PluginValuePotionJS_PluginValuePotion_trackEvent(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    ...
    JS_ReportErrorUTF8(cx, "js_PluginValuePotionJS_PluginValuePotion_trackEvent : wrong number of arguments");
    return false;
}
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginValuePotionJS_PluginValuePotion_init(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    if (argc == 0) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginValuePotionJS_PluginValuePotion_init : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginValuePotionJS_PluginValuePotion_cacheInterstitial(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginValuePotionJS_PluginValuePotion_cacheInterstitial : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginValuePotionJS_PluginValuePotion_setTest(JSContext *cx, uint32_t argc, JS::Value *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
    ...
    JS_ReportErrorUTF8(cx, "js_PluginValuePotionJS_PluginValuePotion_setTest : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
void js_register_PluginValuePotionJS_PluginValuePotion(JSContext *cx, JS::HandleObject global) {
    ...
    jsb_sdkbox_PluginValuePotion_class = &PluginAgeCheq_class;
...
#if MOZJS_MAJOR_VERSION >= 52
    jsb_register_class<sdkbox::PluginValuePotion>(cx, jsb_sdkbox_PluginValuePotion_class, proto);
#else
    jsb_register_class<sdkbox::PluginValuePotion>(cx, jsb_sdkbox_PluginValuePotion_class, proto, JS::NullPtr());
#endif
#else
    ...
    JSString* jsstr = JS_NewStringCopyZ(cx, "PluginValuePotion");
